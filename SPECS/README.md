...
- **027** — фича в плане (F-N): WIZARD_RULES_LIBRARY (вкладка Library: попап с галками, копирование пресетов из шаблона в **custom_rules**; сшивка с шаблоном по **label**; selectable как каталог; см. **SPEC.md**)
